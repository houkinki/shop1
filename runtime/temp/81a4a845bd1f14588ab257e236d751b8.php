<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"D:\xampp\htdocs\shop1\public/../application/admin\view\featured\index.html";i:1562206200;s:63:"D:\xampp\htdocs\shop1\application\admin\view\public\header.html";i:1561344859;s:63:"D:\xampp\htdocs\shop1\application\admin\view\public\footer.html";i:1561344761;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
  ...
  <form method="get" action="<?php echo url('featured/index'); ?>">
      ...
      <div class="formControls col-xs-8 col-sm-3"> <span class="select-box">
        <select name="type" class="select">
          ...
          <option value="<?php echo $key; ?>" <?php if($type == $key): ?> selected="selected" <?php endif; ?>><?php echo $vo; ?></option>
    ...
    <table class="table table-border table-bordered table-bg table-hover table-sort">
      ...
      <?php if(is_array($results) || $results instanceof \think\Collection || $results instanceof \think\Paginator): $i = 0; $__LIST__ = $results;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
        <tr class="text-c">
          ...
          <td><a href="<?php echo url('featured/add',['id'=>$vo['id']]); ?>" data-title="推荐位修改"> <?php echo $vo->title; ?> </a></td>
          <td class="text-c"><?php echo $vo['url']; ?></td>
          <td><?php echo $vo['create_time']; ?></td>
          <td class="td-status"><a href="<?php echo url('featured/status',['id'=>$vo['id'],'status'=>$vo['status']?0:1]); ?>" title="点击修改状态"><?php echo status($vo['status']); ?></a></td>
