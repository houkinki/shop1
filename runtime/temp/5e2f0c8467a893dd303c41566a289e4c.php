<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"D:\xampp\htdocs\shop1\public/../application/admin\view\bis\apply.html";i:1560842635;s:63:"D:\xampp\htdocs\shop1\application\admin\view\public\header.html";i:1561344859;s:63:"D:\xampp\htdocs\shop1\application\admin\view\public\footer.html";i:1561344761;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
		...
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<tbody>
				...
				<tr class="text-c">
					...
					<td class="td-manage">
						<a style="text-decoration:none" class="ml-5" onClick="o2o_edit('商户入驻详情数据','<?php echo url('bis/detail',['id'=>$vo['id']]); ?>','',300)" href="javascript:;" title="编辑">
