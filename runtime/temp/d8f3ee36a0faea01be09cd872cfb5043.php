<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"D:\xampp\htdocs\shop1\public/../application/admin\view\category\index.html";i:1560411150;s:63:"D:\xampp\htdocs\shop1\application\admin\view\public\header.html";i:1561344859;s:63:"D:\xampp\htdocs\shop1\application\admin\view\public\footer.html";i:1561344761;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
		...
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<tbody>
				...
				<tr class="text-c">
					...
					<td class="td-status"><a href="<?php echo url('category/status',['id'=>$vo['id'],'status'=>1?0:1]); ?>" title="点击修改状态"><?php echo status($vo['status']); ?></a></td>
					<td class="td-manage">
						<a href="<?php echo url('category/index',['id'=>$vo['id']]); ?>">获取子栏目</a>
						...
						<a style="text-decoration:none" class="ml-5" onClick="o2o_del('<?php echo url('category/status',['id'=>$vo['id'],'status'=>-1]); ?>')" href="javascript:;" title="删除">
							<i class="Hui-iconfont">&#xe6e2;</i>
						</a>
					</td>
				</tr>
...
<div class="cl pd-5 bg-1 bk-gray mt-20 tp-o2o"><?php echo $categorys->render(); ?></div>
<!--包含头部文件-->
